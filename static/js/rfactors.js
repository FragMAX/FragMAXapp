...
this.createRfactorsPlot = () => {
    ...
    d3.json("/results/rfactor").then(data => {
        ...
        legend.append("circle").attr("cx", 35).attr("cy", 20).attr("r", 6.0).style("fill", maxIVGreen)
        legend.append("circle").attr("cx", 35).attr("cy", 45).attr("r", 6.0).style("fill", maxIVOrange)
        legend.append("text").attr("x", 45).attr("y", 20).text("Rfree").style("font-size", "20px").attr("alignment-baseline", "middle")
        legend.append("text").attr("x", 45).attr("y", 45).text("Rwork").style("font-size", "20px").attr("alignment-baseline", "middle");
