...
def _update_proc_result_entry(project: Project, result_entry, result: ProcStats):
    ...
    if proc_res is None:
        project.db.ProcessResult(
            ...
            low_resolution_overall=result.low_resolution_overall,
            high_resolution_overall=result.high_resolution_overall,
    ...
    proc_res.low_resolution_overall = result.low_resolution_overall
    proc_res.high_resolution_overall = result.high_resolution_overall
