...
class PanddaSelectedDatasets:
    ...
    @staticmethod
    def _get_json_file(pandda_dir: Path):
...
class PanddaAnalyseSites(_PanddaCSVParser):
    ...
    def get_native_centroids(self) -> List[List[float]]:
...
def get_analysis_html_file(project: Project, method: str, date: str) -> Path:
    ...
    return Path(analysis_dir, "html_summaries", "pandda_analyse.html",)
